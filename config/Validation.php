<?php
    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = 'Format de champ '.$this->name.' invalide.';
                }
        ...
        public function country(){
            $country_block = array('ZA','DZ','AO','BJ','BW','BF','BI','CV','KM','CD','CG','CI','DJ','EG','ER','ET','GA','GM','GH','GN','GQ','KE','LS','LR','LY','MG1','MW','ML','MA','MU','MR','YT','MZ','NA','NE','NG','UG','CF','RE','RW','SN','SC','SL','SO','SD','SS','SZ','TZ','TD','TG','TN','ZM');
            $details = json_decode(file_get_contents("http://ipinfo.io/json"));
            $country = $details->country;
            if(in_array($country, $country_block)){
                $this->errors[] ="Vous ne pouvez pas vous inscrire dans votre pays";
            }
           return $this;
        }
        /**
